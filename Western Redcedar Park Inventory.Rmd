...
Something that may want to be considered is reframing the observation field of "Most prevalent Under story species" instead into "Understory Species Found" as the volunteers have been logging every visible understory plant species found near the base of the tree (2 - 10 ft depending on tree size).

I expect this data to change as more parks are inventoried especially where WRC are artificially planted and instead may lack an understory. More questions arise; Are our WRC in our parks doing worse than our WRC in our forests? Would planting WRC with certain understory species increase survivability? Would planting understory species near WRC improve tree condition or help fight rapid decline?

Joey if you are reading this I would be interested in the future analyzing the entire WRC Dieback Project more indepth with hopefully the skills to combine climate data and create a model based on expected temperature changes over the next 10 years.

#### **Indicator Species Analysis**

Indicator Species analysis to check if there are any species that are potential "indicators" of tree health.
```{r}
