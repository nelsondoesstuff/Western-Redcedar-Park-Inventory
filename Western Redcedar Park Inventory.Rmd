...
Something that may want to be considered is re framing the observation field of "Most prevalent Understory species" instead into "Understory Species Found" as the volunteers have been logging every visible understory plant species found within the understory of each tree.
...
Another way to also visually represent the data is to look at the diversity of species at each location.
